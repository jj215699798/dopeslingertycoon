...
var productionUpgradesMaster = [
  ...
  new ProductionUpgrade('Hydroponics', 'High tech agriculture system, increases the amount of weed produced by your cannabis plants by 50%!', 6500, 'Cannabis Plant', 200.5, 'Weed'),
  ...
  new ProductionUpgrade('Irrigation system', 'An computer controlled irrigation system, increases the amount of shrooms produced by your mushroom farms by 50%!', 25000, 'Mushroom Farm', 200.5, 'Magic Mushrooms'),
  ...
  new ProductionUpgrade('Underground Lab', 'Increases the amount of meth made by your cooks by 50%!', 130000, 'Meth Cook', 200.5, 'Meth'),
  ...
  new ProductionUpgrade('Criminal Pharmacy', 'Increases the amount of speed produced by your chefs by 50%!', 190000, 'Base Chef', 200.5, 'Speed'),
  ...
  new ProductionUpgrade('Digital Distillation', 'Increases the amount of acid made by your lab technicians by 50%!', 120000, 'Lab Technician', 200.5, 'Acid'),

  new ProductionUpgrade('Gang protection', 'Increases the amount of crack made by your crack dens by 50%!', 145000, 'Crack Den', 10.5, 'Crack'),
  new ProductionUpgrade('Police Payoff', 'Get the feds off your back to increase the amount of crack made by your crack dens by 45%!', 280000, 'Crack Den', 200.5, 'Crack'),
  ...
  new ProductionUpgrade('Mass Spectrometer', 'Increases the amount of PCP made by your chemical labs by 70%!', 550000, 'Chemical Lab', 200.5, 'PCP'),

  new ProductionUpgrade('Polytunnel complex', 'Increases the amount of heroin made by your opium farms by 50%!', 210000, 'Opium Farm', 10.5, 'Heroin'),
  ...
  new ProductionUpgrade('PhD Students', 'A small army of PhD students to assist the professors in their important work. Increases the amount of MDMA made by your chemistry professors by 60%!', 250000, 'Chemistry Professor', 10.6, 'MDMA'),
  new ProductionUpgrade('Research Facility', 'Increases the amount of MDMA made by your chemistry professors by 40%!', 1000000, 'Chemistry Professor', 200.5, 'MDMA'),
  ...
  new ProductionUpgrade('Cartel deal', 'Broker a deal with a major cartel south of the border. Increases the amount of cocaine smuggled by your drug mules by 80%!', 1500000, 'Drug Mule', 10.8, 'Cocaine'),
  ...
  new ProductionUpgrade('Peachtree Block', 'Give your Chem-techs somewhere safe to work. Increases the amount of Slo-mo produced by 100%!', 575000000, 'Chem-tech', 20000.7, 'Slo-mo'),

  new ProductionUpgrade('The Ludovico Technique', 'Take control over your Droogs and keep them focused on the important work of producing Drencrom. Increases the amount of Drencrom produced by 100%!', 575000000, 'Droog Squad', 20000.7, 'Drencrom'),
...
var drugsMaster = createDrugsMaster();
  ...
  var createProductionMaster = function() {
    return [
      ...
      new Producer('Droog Squad', 35000000, 'Drencrom', 1.31, 0.4),
      new Producer('Sandworm', 75000000, 'Melange', 1.32, 0.4)];
  };
